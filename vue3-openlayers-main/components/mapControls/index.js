...
import SplitterControl from './SplitterControl.vue'
// import FullScreenControl from './FullScreenControl.bak.vue'
...
function install (app) {
  ...
  app.component(SplitterControl.name, SplitterControl)
